...
//
  ...
  var _pergunta = [
    ' ',
  "1. Lidar com algumas pessoas pode ser muito desagradável, mas nunca pode ser terrivel ou horrível.",
  "2. Quando eu cometo um erro, muitas vezes eu digo a mim mesmo: 'Eu não deveria ter feito isso.'",
  "3. Absolutamente, as pessoas devem obedecer a lei.",
  "4. Não há nada que eu 'não possa suportar'.",
  "5. Ser ignorado, ou ser socialmente estranho em uma festa,reduziria meu senso de autoestima.",
  "6. Algumas situações na vida são realmente terríveis.",
  "7. Em algumas áreas eu deveria ser absolutamente mais competente.",
  "8. Meus pais devem ser razoáveis no que eles pedem de mim.",
  "9. Há algumas coisas que eu simplesmente não suporto.",
  "10. Minha autoestima não é maior por causa dos meus sucessos em escola ou no trabalho.",
  "11. A maneira como algumas crianças se comportam é horrível.",
  "12. Eu absolutamente não deveria ter cometido certos erros óbvios na minha vida.",
  "13. Mesmo que tivessem prometido, e era importante para mim, não há nenhuma razão pela qual meus amigos têm que fazer o que eu quero.",
  "14. Eu não posso lidar com isso quando meus amigos (ou meus filhos) se comportam de forma imatura, descontroladamente, ou indevidamente.",
  "15. Há pessoas boas e más, como pode ser visto observando o que eles fazem.",
  "16. Há momentos em que coisas horríveis acontecem.",
  "17. Não há nada que eu deva fazer na vida.",
  "18. As crianças devem eventualmente aprender a cumprir suas obrigações.",
  "19. Às vezes eu simplesmente não posso tolerar a minha pobre realização em escola ou no trabalho.",
  "20. Mesmo quando eu cometo erros graves ou caros, ou machuco outros, minha autoestima não muda.",
  "21. Seria terrível se eu não pudesse ter sucesso em agradar as pessoas que eu amo.",
  "22. Eu gostaria de fazer melhor na escola (ou no trabalho), mas há não é nenhuma razão pela qual eu absolutamente deve fazer melhor.",
  "23. Eu acredito que as pessoas definitivamente não devem se comportar mal em público.",
  "24. Não aguendo muita pressão e estresse.",
  "25. A aprovação ou desaprovação de meus amigos ou familiares não afeta minha autoestima.",
  "26. Seria lamentável, mas não terrível, se alguém da minha família tivesse sérios problemas médicos.",
  "27. Eu definitivamente tenho que fazer um bom trabalho em todas as coisas que eu decido para fazer.",
  "28. Geralmente é bom para os adolescentes agir de forma diferente, comendo pizza no café da manhã e deixando roupas e livros por todo o chão em seu quarto.",
  "29. Eu não posso suportar algumas das coisas que foram feitas por meus amigos ou membros da minha família.",
  "30. Uma pessoa que peca ou prejudica os outros repetidamente é uma 'má pessoa'.",
  "31. Seria horrível se alguém que eu amasse desenvolvesse sério problemas mentais e tivesse que ser hospitalizado.",
  "32. Eu tenho que ter certeza absoluta de que tudo está indo bem em áreas importantes da minha vida.",
  "33. Se é importante para mim, amigos próximos devem querer fazer os favores que eu peço a eles.",
  "34. Eu posso facilmente tolerar situações muito desagradáveis e desconfortáveis, interações estranhas com amigos.",
  "35. A forma como os outros me avaliam (amigos, supervisores, professores) é muito importante na determinação da maneira como eu me classifico.",
  "36. É terrível quando meus amigos se comportam mal e inapropriadamente em público.",
  "37. Eu claramente não deveria cometer alguns dos erros que eu cometo.",
  "38. Não há razão para que meus familiares ajam da maneira que eu quero.",
  "39. É insuportável quando muitas e muitas coisas dão errado.",
  "40. Eu muitas vezes me classifico com base no meu sucesso no trabalho ou escola, ou sobre minhas realizações sociais.",
  "41. Seria terrível se eu falhasse totalmente na escola ou no trabalho.",
  "42. Não há razão para que eu deva ser uma pessoa melhor do que eu sou.",
  "43. Há claramente algumas coisas que outras pessoas não devam fazer.",
  "44. Há algumas coisas sobre as pessoas no trabalho (ou em escola) que eu simplesmente não posso lidar.",
  "45. Sérios problemas emocionais ou legais diminuem meu senso de autoestima.",
  "46. Mesmo situações muito ruins e desagradáveis como falhar, ou perder muito dinheiro ou um emprego não são terríveis.",
  "47. Há algumas boas razões pelas quais eu não devo cometer erros na escola ou no trabalho.",
  "48. Absolutamente, meus amigos e minha família devem me tratar melhor do que às vezes o fazem.",
  "49. Eu posso facilmente aceitár, quando meus amigos não se comportam de maneira que eu espero que eles deveriam.",
  "50. É importante ensinar as crianças que elas podem se tornar 'bons meninos' e 'boas meninas' por ter um bom desempenho em escola e ganhar a aprovação de seus pais.",
