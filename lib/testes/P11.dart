...
import 'package:wop3desenvolvimento_app/descricao/Intimidade.dart';
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_intimidade = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10 + _V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17 + _V18 + _V19 + _V20 + _V21 + _V22 + _V23 + _V24 + _V25 + _V26 + _V27 + _V28 + _V29 + _V30 + _V31 + _V32 + _V33 + _V34 + _V35);
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Intimidade" : score_intimidade ,
          "Test_name":"Intimidade",
          "Code":"D11","Data-teste": _formattedDate,
          ...
          "P31" : _V31, "P32" : _V32, "P33" : _V33,"P34" : _V34,"P35" : _V35
        }
    );
    //
    db.collection("aluno")
...
//
  ...
  var _pergunta = [
    ' ',
    "1. Eu me sentiria desconfortável em contar para x sobre as coisas no passado que eu senti vergonha.",
    "2. Eu me sentiria desconfortável falando com X sobre algo que me machucou profundamente.",
    "3. Eu me sentiria confortável expressando meus verdadeiros sentimentos para X.",
    "4. Se X estivesse chateado eu às vezes teria medo de mostrar que eu me importo.",
    "5. Eu poderia ter medo de confiar meus sentimentos mais íntimos a X.",
    "6. Eu me sentiria à vontade dizendo a X que eu me importo com ele.",
    "7. Eu teria um sentimento de completa união com X.",
    "8. Eu ficaria confortável discutindo problemas significativos com X.",
    "9. Uma parte de mim teria medo de assumir um compromisso de longo prazo para X.",
    "10. Eu me sentiria confortável contando para X minhas experiências, mesmo tristes.",
    "11. Eu provavelmente me sentiria nervoso mostrando X sentimentos fortes de afeto.",
    "12. Eu acharia difícil ser aberto com X sobre o meus pensamentos.",
    "13. Eu me sentiria nervoso mostrando para X meus sentimentos de afeto.",
    "14. Eu não teria medo de compartilhar com X o que eu não gosto sobre mim mesmo.",
    "15. Eu teria medo de correr o risco de ser ferido a fim para estabelecer uma relação mais próxima com X.",
    "16.Eu me sentiria confortável mantendo informações muito pessoais para mim mesmo.",
    "17. Eu não ficaria nervoso por ser espontâneo com X.",
    "18. Eu me sentiria confortável dizendo para x coisas que eu não diria a outras pessoas.",
    "19. Eu me sentiria confortável confiando em X com o meu mais profundo pensamentos e sentimentos.",
    "20. Eu às vezes me sentiria desconfortável se X me falasse sobre assuntos pessoais.",
    "21. Eu ficaria confortável revelando para X quais são minhas deficiências.",
    "22. Eu ficaria confortável em ter um acordo emocional entre nós.",
    "23. Eu teria medo de compartilhar meus pensamentos privados com X.",
    "24. Eu teria medo de que eu nem sempre me sentisse perto de X.",
    "25. Eu ficaria confortável dizendo a X quais são as minhas necessidades.",
    "26. Eu teria medo de que X seria mais investido no relação do que eu seria.",
    "27. Eu me sentiria confortável em ter uma comunicação aberto e honesta com X.",
    "28. Eu às vezes me sentia desconfortável ouvindoos problemas pessoais de X.",
    "29. Eu me sentiria à vontade para ser completamente eu mesmo com X.",
    "30. Eu me sentiria relaxado estando juntos e falando sobre nossos objetivos pessoais.",
    "31. Eu me afastei das oportunidades de estar perto  de alguém.",
    "32. Eu segurei meus sentimentos em relacionamentos anteriores.",
    "33. Há pessoas que pensam que eu tenho medo de chegar perto delas.",
    "34. Há pessoas que pensam que eu não sou uma pessoa fácil de se conhecer.",
    "35. Eu fiz coisas em relacionamentos anteriores para me aproximar."
