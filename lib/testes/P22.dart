...
class P22 extends StatefulWidget {
  String _codAluno;
  P22(this._codAluno);
  @override
  _P22State createState() => _P22State();
}

class _P22State extends State<P22> {
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_mortabilidade = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10 + _V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17);
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Mortabilidade" : score_mortabilidade ,

          "Test_name":"Mortabilidade",
          "Code":"D22", "Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    " ",
    "1. Eu desenvolvi uma compreensão pessoal da existência que me ajuda a apreciar plenamente a vida.",
    "2. O ambiente físico em que eu vivo são muito Saudável.",
    "3. Nada de interessante acontece na minha vida.",
    "4. Eu não tenho nenhuma influência no meu entorno.",
    "5. Não tenho valor aos olhos da sociedade.",
    "6. Se eu morresse hoje, sinto que absolutamente nenhum traço ou influência de mim mesmo permaneceria.",
    "7. Participo do desenvolvimento de muitos outros.",
    "8. Eu sinto que, apesar da minha morte inevitável, eu sempre ser parte integrante do mundo.",
    "9. Sinto que estou fazendo o que quero na vida.",
    "10. Eu tenho certos valores ou crenças que me ajudam a aceitar ou subir acima da minha condição mortal.",
    "11. Tenho a sensação de que a natureza humana está condenada à destruição.",
    "12. Relacionamentos íntimos me assustam.",
    "13. Uma vez que eu decidi fazer algo, eu faço com sustentado Interesse.",
    "14. Muitas vezes me sinto muito sozinha.",
    "15. A eventualidade da minha morte contribui para dar significado e estrutura para minha vida.",
    "16. Minha vida sexual contribui muito para o meu bem-estar.",
    "17. Tenho dificuldade em empreender coisas novas.",
    "18. Eu me sinto confortável em meu corpo.",
    "19. Minha vida amorosa me traz alegria.",
    "20. Eu me sinto competente no que faço.",
    "21. Se eu morresse hoje, tenho a sensação de que viveria em certas pessoas que eu deixaria para trás.",
    "22. Estou cheio de energia e vitalidade.",
    "23. Não tenho certeza de quem eu sou.",
    "24. Estou satisfeito com minha vida até agora.",
    "25. Tenho bom contato com os outros.",
    "26. Sinto que não uso bem o meu tempo.",
  ...
  _alteraResultado() {
    ...
    if      (_valorpergunta[_numeroAnterior] == 1)  { _c1 = true;}
    else if (_valorpergunta[_numeroAnterior] == 2) { _c2 = true;}
    else if (_valorpergunta[_numeroAnterior] == 3) { _c3 = true;}
    else if (_valorpergunta[_numeroAnterior] == 4) { _c4 = true;}
    else if (_valorpergunta[_numeroAnterior] == 5) { _c5 = true;}
    else if (_valorpergunta[_numeroAnterior] == 6) { _c6 = true;}
    else if (_valorpergunta[_numeroAnterior] == 7) { _c7 = true;}
  }
  //
  void _limpaBotao () {
