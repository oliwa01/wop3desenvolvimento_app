...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_pr  = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10 +_V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17 + _V18 + _V19 + _V20 );
    score_pi  = (_V21 + _V22 + _V23 + _V24 + _V25 + _V26 + _V27 + _V28 + _V29 + _V30 +_V31 + _V32 + _V33 + _V34 + _V35 + _V36 + _V37 + _V38 + _V39 + _V40 + _V41 + _V42 + _V43 + _V44 + _V45 + _V46 + _V47);
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Preocupacao_razoes" : score_pr ,
          "Preocupacao_incerteza" : score_pi ,
          "Test_name":"ESCALA DE PREOCUPAÇÃO",
          "Code":"D08","Data-teste": _formattedDate,
          ...
          "P41" : _V41, "P42" : _V42, "P43" : _V43,"P44" : _V44,"P45" : _V45,"P46" : _V46,"P47" : _V47
        }
    );
    //
    db.collection("aluno")
...
//
  ...
  var _pergunta = [
    ' ',
    "1. Quando me preocupo, sinto que sou o único a ter dificuldades.",
    "2. Preocupar-se com coisas menos importantes me distrai de assuntos mais emocionais que eu não quero pensar.",
    "3. Se eu me preocupar, posso encontrar uma maneira melhor de ser.",
    "4. Eu me preocupo porque estou acostumado a me preocupar.",
    "5. Eu me preocupo porque eu aprendi a sempre esperar o pior.",
    "6. Eu me preocupo porque se o pior acontecer, eu me sentiria culpado se eu não tivesse me preocupado.",
    "7. Eu me preocupo em tentar proteger o mundo.",
    "8. Se eu me preocupar, posso encontrar melhores maneiras de fazer as coisas.",
    "9. Eu me preocupo em tentar me proteger melhor.",
    "10. Se eu não me preocupar e o pior acontece, seria minha culpa.",
    "11. Eu me preocupo com o passado para aprender com meus erros.",
    "12. Quando me preocupo, acho que a vida parece muito mais fácil para outros do que para mim.",
    "13. Eu me preocupo em tentar ter um melhor controle sobre a minha vida.",
    "14. Eu me preocupo porque se o pior acontecer, eu não seria capaz para lidar.",
    "15. Eu me preocupo em evitar desapontamentos.",
    "16. Quando eu me preocupo, eu digo a mim mesmo que deve haver sempre um solução para cada problema.",
    "17. Eu me preocupo com muitas pequenas coisas para que eu não pense sobre coisas mais importantes.",
    "18. Por me preocupar, posso impedir que coisas ruins aconteçam.",
    "19. Mesmo que eu saiba que não é verdade, eu sinto que se preocupar pode diminuir a probabilidade de que coisas piores aconteçam.",
    "20. Se eu me preocupar menos, tenho menos chance de encontrar a melhor solução.",
    "21. A incerteza me impede de ter uma opinião firme.",
    "22. Ser incerto significa que uma pessoa é desorganizada.",
    "23. A incerteza torna a vida intolerável.",
    "24. Não é justo que não haja garantias na vida.",
    "25. Minha mente não pode ser relaxada se eu não sei o que vai acontecer Amanhã.",
    "26. A incerteza me deixa inquieto, ansioso ou estressado.",
    "27. Imprevistos me perturbaram muito.",
    "28. Me frustra não ter todas as informações que preciso.",
    "29. Ser incerto me permite prever as consequências de antemão e para se preparar para eles.",
    "30. Deve-se sempre olhar para frente para evitar surpresas.",
    "31. Um pequeno imprevisto pode estragar tudo, mesmo com o melhor do planejamento.",
    "32. Quando é hora de agir a incerteza me paralisa.",
    "33. Ser incerto significa que eu não sou superior.",
    "34. Quando estou incerto, não posso seguir em frente.",
    "35. Quando estou incerto, não posso funcionar muito bem.",
    "36. Ao contrário de mim, outros sempre parecem saber onde estão indo com suas vidas.",
    "37. A incerteza me deixa vulnerável, infeliz ou triste.",
    "38. Eu sempre quero saber o que o futuro tem reservado para mim.",
    "39. Odeio ser pego de surpresa.",
    "40. A menor dúvida me impede de atuar.",
    "41. Eu deveria ser capaz de organizar tudo com antecedência.",
    "42. Ser incerto significa que não tenho confiança.",
    "43. Eu acho que é injusto que outras pessoas parecem ter certeza sobre a seu futuro.",
    "44. A incerteza me impede de dormir bem.",
    "45. Eu devo fugir de situações incertas.",
    "46. As ambiguidades na vida me estressam.",
    "47. Não suporto ficar indeciso sobre meu futuro."
...
//
  ...
  Widget build(BuildContext context) {
    ...
    //
    String item_1 = "Nada característico comigo.";
    String item_2 = "Pouco característico comigo.";
    String item_3 = "Alguma característica comigo";
    String item_4 = "Muito característico comigo";
    String item_5 = "Totalmente característico comigo.";


    String t08 = "images/t08.gif";
