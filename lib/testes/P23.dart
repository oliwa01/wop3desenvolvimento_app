...
class P23 extends StatefulWidget {
  String _codAluno;
  P23(this._codAluno);
  @override
  _P23State createState() => _P23State();
}

class _P23State extends State<P23> {
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_novo = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10
        + _V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17 + _V18 + _V19 + _V20
        + _V21 + _V22 + _V23 + _V24 + _V25 + _V26 + _V27 + _V28 + _V29 + _V30
         + _V31 + _V32 + _V33 + _V34 + _V35 + _V36 + _V37 + _V38);
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Lidar_com_Novo" : score_novo ,
          "Test_name":"LIDAR COM O NOVO",
          "Code":"D23", "Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    " ",
  "1. Acho que deveria haver menos mudanças em nossa sociedade.",
  "2. Fico desconfortável quando as coisas permanecem as mesmas por muito tempo.",
  "3. Ao pedir uma refeição em um restaurante, eu costumo evitar pratos ou pratos incomuns que eu nunca provei antes.",
  "4. Quando eu escolher onde eu gostaria de ir para férias, Eu costumo escolher lugares incomuns ou exóticos.",
  "5. A estrutura da nossa sociedade deve mudar menos do que ela faz.",
  "6. As pessoas que me conhecem parecem pensar que eu sou um estranho e coisas incomuns.",
  "7. Quando vou ver um filme, costumo evitar os filmes 'Artisticos'.",
  "8. Meus gostos em música não são ortodoxos.",
  "9. Eu prefiro fazer um curso estranho, mas interessante do que um mais convencional, mas útil.",
  "10. O estilo das minhas roupas são um pouco estranhos.",
  "11. Acupuntura não pode fazer nada , que a medicina convencional não possa fazer melhor.",
  "12. Impossivel pode acontecer.",
  "13. Eu gostaria de ser um dos primeiros passageiros a ir para o Lua.",
  "14. Os costumes sexuais atuais são muito permissivos.",
  "15. As coisas que dou risada ,são as coisas que a maioria das pessoas pensam ser engraçados.",
  "16. Mais pessoas devem experimentar Drogas com 'alterações da mente' .",
  "17. Dada a chance, eu prefiro saltar de paraquedas de um avião do que ir a um baile.",
  "18. Eu não gostaria que meu namorado/namorada/cônjuge fosse diferente do que as pessoas esperam que ele seja.",
  "19. Eu nunca gostaria de tentar comer insetos.",
  "20. Estou sempre pensando em melhores maneiras de fazer as coisas.",
  "21. Não gosto de correr riscos.",
  "22. Às vezes me pergunto como seria ser alguém Mais.",
  "23. A maioria das pessoas são mais reservadas do que eu.",
  "24. Há muito a ser dito para a tradição.",
  "25. Eu posso entender aqueles que anseiam por 'O Bom Velho Dias.'",
  "26. Velhos amigos são os melhores amigos.",
  "27. Eu era mais feliz quando era mais jovem.",
  "28. Eu não acredito que é certo aprovar leis sobre questões de Moral.",
  "29. Mesmo quando a maioria das pessoas fazem algo de uma maneira, há geralmente uma maneira melhor se procurarmos por ele.",
  "30. Não existe 'coisa tão ruim' como uma má pessoa.",
  "31. O crime é causado pelas situações que as pessoas se encontram.",
  "32. Mudanças nos papéis sexuais nos levaram a uma posição sobre a razão.",
  "33. As pressões pela igualdade sexual foram longe demais.",
  "34. Eu gosto de mudança.",
  "35. As coisas estão mudando muito na minha vida agora.",
  "36. As pessoas devem sempre buscar o crescimento pessoal.",
  "37. Muitas vezes anseio pela simplicidade do passado.",
  "38. Eles não fazem as coisas como costumavam fazer.",
...
//
  ...
  Widget build(BuildContext context) {
    ...
    String item_1 = "DISCORDO FORTEMENTE.";
    String item_2 = "DISCORDO LEVEMENTE.";
    String item_3 = "CONCORDO E DISCORDO IGUALMENTE.";
    String item_4 = "CONCORDO LEVEMENTE.";
    String item_5 = "CONCORDO FORTEMENTE.";
    //
    //
    String t23 = "images/t23.gif";
