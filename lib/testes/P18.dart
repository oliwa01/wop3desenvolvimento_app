...
class P18 extends StatefulWidget {
  String _codAluno;
  P18(this._codAluno);
  @override
  _P18State createState() => _P18State();
}

class _P18State extends State<P18> {
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_autoeficiencia_geral = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10 + _V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17);
    score_autoeficiencia_especifica = ( _V18 + _V19 + _V20 + _V21 + _V22 + _V23);
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Auto_eficiencia Geral" : score_autoeficiencia_geral ,
          "Auto_eficiencia especifica" : score_autoeficiencia_especifica ,
          "Test_name":"Eficiencia",
          "Code":"D18", "Data-teste": _formattedDate,
...
//
  ...
  int  score_autoeficiencia_geral = 0;
  int  score_autoeficiencia_especifica = 0;
  ...
  var _pergunta = [
    " ",
    "1. Quando faço planos, tenho certeza que posso fazê-los funcionar.",
    "2. Um dos meus problemas é que eu não posso começar a trabalhar quando eu gostaria.",
    "3. Se eu não posso fazer um trabalho da primeira vez, eu continuo tentando até conseguir.",
    "4. Quando eu faço metas importantes para mim, eu raramente alcanço eles.",
    "5. Eu desisto das coisas antes de completá-las.",
    "6. Evito enfrentar dificuldades.",
    "7. Se algo parece muito complicado, eu não vou tentar faze-las.",
    "8. Quando eu tenho algo desagradável para fazer, eu envolver a ele até eu terminá-lo.",
    "9. Quando eu decido fazer algo, eu vou direto para trabalhar nisso.",
    "10. Ao tentar aprender algo novo, eu logo desistir se eu não sou inicialmente bem sucedido.",
    "11. Quando ocorrem problemas inesperados, eu não os lido com eles Bem.",
    "12. Eu evito tentar aprender coisas novas quando elas perecem difíceis para mim.",
    "13. O fracasso só me faz tentar mais.",
    "14. Eu me sinto inseguro sobre a minha habilidade de fazer as coisas.",
    "15. Eu sou uma pessoa auto-confiante.",
    "16. Eu desisto facilmente.",
    "17. Eu não pareço capaz de lidar com a maioria dos problemas que surgem na vida.",
    "18. É difícil para mim fazer novos amigos.",
    "19. Se eu ver alguém que eu gostaria de conhecer, eu vou para essa pessoa em vez de esperar por ele ou ela para vir a mim.",
    "20. Se eu conhecer alguém interessante que é difícil de fazer amigos com, eu vou em breve parar de tentar fazer amigos com essa pessoa.",
    "21. Quando estou tentando me tornar amigo de alguém que parece desinteressado no início, eu não desisto facilmente.",
    "22. Eu não me lido bem em reuniões sociais.",
    "23. Eu adquiri meus amigos através de minhas habilidades pessoais",
  ...
  _montaResultado() {
    ...
    (_npergunta == 20) |
   (_npergunta == 22)) {
      if (_c1) { _resultado = 14; }
      else if (_c2) { _resultado = 12; }
      else if (_c3) { _resultado = 10; }
      else if (_c4) { _resultado = 8; }
      else if (_c5) { _resultado = 6; }
      else if (_c6) { _resultado = 4; }
      else if (_c7) { _resultado = 2; }}
    else {
      if (_c1) { _resultado = 2; }
      else if (_c2) { _resultado = 4; }
      else if (_c3) { _resultado = 6; }
      else if (_c4) { _resultado = 8; }
      else if (_c5) { _resultado = 10; }
      else if (_c6) { _resultado = 12; }
      else if (_c7) { _resultado = 14; }
    }
...
//
  ...
  Widget build(BuildContext context) {
    ...
    String item_1 = "DICORDO TOTALMENTE";
    String item_2 = "DISCORDO MUITO";
    String item_3 = "DISCORCO BASTANTE";
    String item_4 = "NEM CONCORDO / NEM DISCORDO";
    String item_5 = "CONCORDO BASTANTE";
    String item_6 = "CONCORDO MUITO";
    String item_7 = "CONCORDO TOTALMENTE";
