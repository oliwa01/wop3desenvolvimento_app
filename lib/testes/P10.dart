...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_acertivo = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10 + _V11 + _V12 + _V13 + _V14 + _V15 + _V16 + _V17 + _V18 + _V19 + _V20 + _V21 + _V22 + _V23 + _V24 + _V25 + _V26 + _V27 + _V28 + _V29 + _V30 + _V31 + _V32 + _V33 + _V34 + _V35 + _V36 + _V37 + _V38 + _V39 + _V40 + _V41 + _V42 + _V43 + _V44 + _V45 + _V46 + _V47 );
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Acertivo" : score_acertivo ,
          "Test_name":"Acertivo",
          "Code":"D10","Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    ' ',
    "1. Você ignora quando alguém fura a sua frente na fila?",
    "2. Você acha difícil pedir a um amigo para fazer um favor para você?",
    "3. Se o seu chefe ou supervisor faz o que você considera um pedido irracional, você tem dificuldade em dizer não?",
    "4. Você está relutante em falar com um conhecido atraente do sexo oposto?",
    "5. É difícil para você recusar pedidos irracionais de seus pais?",
    "6. Você acha difícil aceitar elogios de sua chefe ou supervisor?",
    "7. Você expressa seus sentimentos negativos aos outros quando é apropriado?",
    "8. Você voluntaria livremente informações ou opiniões em discussões com pessoas que você não conhece bem?",
    "9. Se houvesse uma figura pública a quem você admirava muito e respeitado em uma grande reunião social, você fazer um esforço para se apresentar?",
    "10. Quantas vezes você expressa abertamente sentimentos justificados de raiva para seus pais?",
    "11. Se você tem um amigo de quem seus pais não aprovam, você faz um esforço para ajudá-los a conhecer um ao outro melhor?",
    "12. Se você estivesse assistindo um programa de TV em que você estava muito interessado e um parente próximo estava perturbando você, você pediria para eles ficarem quietos?",
    "13. Você desempenha um papel importante na decisão de como você e seus amigos próximos passam seu tempo livre juntos?",
    "14. Se você está com raiva do seu cônjuge/namorado/namorada, é isso difícil para você dizer a ele?",
    "15. Se um amigo que deveria te pegar para um importante compromisso chama 15 minutos antes de ser deveria estar lá e diz que não pode fazer esperar, você expressa seu aborrecimento?",
    "16. Se você está atrasada e tem que parar em um supermercado para pegar alguns itens, você pediria para ir antes de alguém na fila do caixa?",
    "17. Você acha difícil recusar os pedidos dos outros?",
    "18. Se seu chefe ou supervisor expressa opiniões com que você discorda fortemente, você se aventura a afirmar seu próprio ponto de vista?",
    "19. Se você tem um amigo próximo a quem seu cônjuge/namorado/ Namorada não gosta e constantemente crítica, você diria que você discorda e diria os pontos positivos do seu amigo?",
    "20. Você acha difícil pedir favores aos outros? ",
    "21. Se a comida que não é para sua satisfação foi servida em um bom restaurante, você traria isso para a atenção do garçom?",
    "22. Você tende a arrastar suas desculpas?",
    "23. Quando necessário, você acha difícil pedir favores de seus pais?",
    "24. Você insiste que os outros façam sua parte correta do trabalho?",
    "25. Você tem dificuldade em dizer não aos vendedores?",
    "26. Você está relutante em falar em uma discussão com um pequeno grupo de amigos?",
    "27. Você expressa raiva ou aborrecimento ao seu chefe ou supervisor quando é justificado?",
    "28. Você elogia os outros?",
    "29. Você tem dificuldade em pedir a um amigo próximo para fazer um importante favor, mesmo que isso vai causar-lhe algum inconveniente?",
    "30. Se um parente próximo faz o que você considera ser um irracional pedido, você tem dificuldade em dizer não?",
    "31. Se seu chefe ou supervisor fizer uma declaração de que você considerar falso, você questioná-lo em voz alta?",
    "32. Se você se encontra um grande amigo, você tem dificuldade em expressar esses sentimentos para essa pessoa?",
    "33. Você tem dificuldade em trocar uma compra com que você está insatisfeito?",
    "34. Se alguém em autoridade interrompa você no meio de uma conversa importante, você pede que a pessoa esperar até terminar?",
    "35. Se uma pessoa do sexo oposto que você se interessa olha para você em uma festa, você toma a iniciativa de começar uma conversa?",
    "36. Você hesita em expressar ressentimento a um amigo que fez algo que você não gostou?",
    "37. Se você morasse fora  da casa de seus pais , e eles quisessem que você voltasse para casa por num final de semana, que você tem outros importantes planos. Você mudaria seus planos?",
    "38. Você está relutante em falar em uma discussão ou debate? ",
    "39. Se um amigo que pegou emprestado 5.00 de você, e parece ter esquecido sobre isso, é difícil para você lembrar essa pessoa?",
    "40. Se o seu chefe ou supervisor provoca você ao ponto de te chatear, você tem dificuldade em expressar o seu descontentamento?",
    "41. Se seu cônjuge/namorado/namorada é flagrantemente injusto, faça você acha difícil dizer algo sobre isso para ele? ",
    "42. Se um funcionário em uma loja chama por alguém que entrou depois de você, você chama sua atenção para o fato?",
    "43. Se você morasse em um apartamento alugado e o proprietário não fizesse as manutenções combinadas, você insistiria no conserto?",
    "44. Você acha difícil pedir ao seu chefe ou supervisor para deixá-lo sair mais cedo?",
    "45. Você tem dificuldade em expressar verbalmente amor e afeto para seu cônjuge/namorado/namorada?",
    "46. Você prontamente expressa suas opiniões aos outros?",
    "47. Se um amigo faz o que você considera ser um pedido irracional, você é capaz de recusar?",
...
//
  ...
  Widget build(BuildContext context) {
    ...
    //
    String item_1 = "Quase Sempre.";
    String item_2 = "Normalmente.";
    String item_3 = "As vezes.";
    String item_4 = "Raramente.";
    String item_5 = "Nunca.";
    String t10 = "images/t10.gif";
