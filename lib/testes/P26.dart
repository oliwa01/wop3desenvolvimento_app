...
class P26 extends StatefulWidget {
  String _codAluno;
  P26(this._codAluno);
  @override
  _P26State createState() => _P26State();
}

class _P26State extends State<P26> {
  ...
  void _gravaDb () {
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          ...
          "Test_name":"PERCEPÇÃO LÓGICA",
          "Code":"D26","Data-teste": _formattedDate,
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/t31.gif"),
              fit: BoxFit.cover,
            )),
        child: ListView(
          children: <Widget>[
