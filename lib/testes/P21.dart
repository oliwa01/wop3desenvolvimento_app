...
class P21 extends StatefulWidget {
  String _codAluno;
  P21(this._codAluno);
  @override
  _P21State createState() => _P21State();
}

class _P21State extends State<P21> {
...
*/
  ...
  void _gravaDb () {
    _carregaTab();
    score_empatia  = (_V01 + _V02 + _V03 + _V04 + _V05 + _V06 + _V07 + _V08 + _V09 + _V10
    ...
    db.collection("aluno")
        ...
        .setData(
        {
          "Empatia" : score_empatia ,
          "Test_name":"Empatia",
          "Code":"D21","Data-teste": _formattedDate,
...
//
  ...
  var _pergunta = [
    ' ',
    "1. Fico triste ver alguem isolado e solitário em um grupo.",
    "2. As pessoas trazem muito dos sentimentos e sensibilidade dos Animais.",
    "3. Muitas vezes acho as demonstrações públicas de afeto irritantes.",
    "4. Fico irritado com pessoas infelizes que estão apenas arrependidos.",
    "5. Fico nervoso se outros ao meu redor parecerem nervosos.",
    "6. Eu acho bobagem as pessoas gritarem pela felicidade.",
    "7. Eu costumo me envolver emocionalmente com os problemas de um amigo.",
    "8. Às vezes, as palavras de uma canção de amor podem me mover profundamente.",
    "9. Eu tendo a perder o controle quando eu estou trazendo más notícias para as pessoas.",
    "10. As pessoas ao meu redor têm uma grande influência na meu humor.",
    "11. A maioria dos estrangeiros que conheci, pareciaa legais mas sem emoção.",
    "12. Eu prefiro ser um assistente social do que trabalhar em um trabalho centro de treinamento.",
    "13. Eu não fico chateado só porque um amigo está agindo triste.",
    "14. Gosto de ver as pessoas abrirem presentes.",
    "15. Pessoas solitárias provavelmente são hostis.",
    "16. Ver as pessoas chorarem me chateia.",
    "17. Algumas músicas me fazem feliz.",
    "18. Eu realmente me envolvo com os sentimentos dos personagens em um romance.",
    "19. Fico muito zangado quando vejo alguém sendo maltratado.",
    "20. Eu sou capaz de manter a calma mesmo que aqueles ao meu redor se preocupam.",
    "21. Quando um amigo começa a falar sobre seus problemas, eu tento direcionar a conversa para outra coisa.",
    "22. O riso dos outros não está pegando para mim.",
    "23. Às vezes, nos filmes, eu me divirto com a quantidade de pessoas chorando ao meu redor.",
    "24. Sou capaz de tomar decisões sem ser influenciado pelos sentimentos das pessoas.",
    "25. Eu não posso continuar a me sentir bem se as pessoas ao meu redor estão deprimidas.",
    "26. É difícil para mim ver como algumas coisas perturbam tanto as pessoas.",
    "27. Fico muito chateado quando vejo um animal com dor.",
    "28. Envolver-se em livros ou filmes é um pouco bobo.",
    "29. Me chateia ver velhos indefesos.",
    "30. Eu fico mais irritado do que simpático quando vejo lágrimas de alguém.",
    "31. Eu me envolvo muito quando vejo um filme.",
    "32. Eu muitas vezes acho que eu posso permanecer frio, apesar da excitação ao meu redor.",
    "33. Crianças pequenas às vezes choram sem motivo aparente."
  ];
  bool _s1 = false;
  bool _c1 = false;
  bool _c2 = false;
