...
class GraficosP10 extends StatefulWidget {
  ...
  Color cv1; Color cv2; Color cv3 ;Color cv4; Color cv5; Color cv6; Color cv7; Color cv8; Color cv9;
  String _codAluno;

  GraficosP10(this._codAluno,this.v1,this.cv1,this.v2,this.cv2,this.v3,this.cv3,this.v4,this.cv4,this.v5,this.cv5,this.v6,this.cv6,this.v7,this.cv7,this.v8,this.cv8,this.v9,this.cv9);
...
class _GraficosP10State extends State<GraficosP10> {
  ...
  _generateData() async {
    var data1 = [
      new Resultados(1, "VERBAL", widget.v1, widget.cv1),
      new Resultados(2, "ESPACIAL", widget.v2, widget.cv2),
      new Resultados(3, "MUSICAL", widget.v3, widget.cv3),
      new Resultados(4, "CORPORAL", widget.v4, widget.cv4),
      new Resultados(5, "INTERPESSOAL", widget.v5, widget.cv5),
      new Resultados(6, "INTRAPESSOAL", widget.v6, widget.cv6),
      new Resultados(7, "IDEOLOGICA", widget.v7, widget.cv7),
      new Resultados(8, "BIOLOGICA", widget.v8, widget.cv8),
     new Resultados(8, "ESPIRITUAL", widget.v9, widget.cv9)
  ...
  String _textoAnsiedade = "";
  String _textoStress = "";
  String _textoDispersao = "";
  String _textoHiperatividade  = "";
  String _textoRelacionamento = "";
  String _textoDepressao = "";
  String _textoAutoLesao = "";
//
