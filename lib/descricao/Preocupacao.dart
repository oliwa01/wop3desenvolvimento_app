...
class Preocupacao extends StatefulWidget {
  String _codAluno;
  Preocupacao(this._codAluno);
  @override
  _PreocupacaoState createState() => _PreocupacaoState();
}

class _PreocupacaoState extends State<Preocupacao> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Todo mundo se preocupa de vez em quando. Você encontrará uma série de declarações que podem se aplicar a preocupantes. Use a escala abaixo para descrever até que ponto cada item lhe é característico."+
                                          "\n\nInteiramente característico de mim"+
                                          "\nMuito característico de mim"+
                                          "\nUm pouco característico de mim"+
                                          "\nUm pouco característico de mim"+
                                          "\nNão é de todo característico de mim"+
