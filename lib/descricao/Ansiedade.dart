...
class Ansiedade extends StatefulWidget {
  String _codAluno;
  Ansiedade(this._codAluno);
  @override
  _AnsiedadeState createState() => _AnsiedadeState();
}

class _AnsiedadeState extends State<Ansiedade> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Este questionário contém sessenta itens relativos a dificuldadesque a maioria das pessoas experimenta de tempos em tempos. "+
                                          "\nLeia cada item cuidadosamente. Se você já experimentou algum dos pensamentos, sentimentos, sintomas físicos, ou comportamentos da maneira indicada por qualquerdos itens, responda com \n'Sim'. "+
                                          "\nSe você não tem, responda com um \n 'Não'. "+
                                          "\ncertifique-se de que nenhum dos itens seja omitido. "+
                                          "\nnão gaste muito tempo em nenhuma pergunta. "+
                                          "\vEstamos interessadosem sua primeira reação, não uma resposta profundamente considerada."+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P02(widget._codAluno)));
