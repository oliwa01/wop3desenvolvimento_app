...
class Alegria extends StatefulWidget {
  String _codAluno;
  Alegria(this._codAluno);
  @override
  _AlegriaState createState() => _AlegriaState();
}

class _AlegriaState extends State<Alegria> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações descrevem uma variedade de experiências as pessoas tiveram. Leia cada item com atenção e indique se é 'Verdadeiro' ou 'Falso' para você."+
                                          "\n\n"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P24(widget._codAluno)));
