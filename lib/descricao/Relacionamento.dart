...
class Relacionamento extends StatefulWidget {
  String _codAluno;
  Relacionamento(this._codAluno);
  @override
  _RelacionamentoState createState() => _RelacionamentoState();
}

class _RelacionamentoState extends State<Relacionamento> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações dizem respeito a opiniões e sentimentos que você pode segurar em direção a outra pessoa. Com relação ao membro do o sexo oposto com quem você está mais envolvido no presente tempo (designado como X), indicar a extensão em que você concorda ou discordar de cada declaração por escrito no número que melhor expressa sua opinião ou sentimento de acordo com a chave abaixo:"+
                                          "\n\nDiscordo fortemente"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P15(widget._codAluno)));
