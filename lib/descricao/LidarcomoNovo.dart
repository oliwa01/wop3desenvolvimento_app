...
class LidarcomoNovo extends StatefulWidget {
  String _codAluno;
  LidarcomoNovo(this._codAluno);
  @override
  _LidarcomoNovoState createState() => _LidarcomoNovoState();
}

class _LidarcomoNovoState extends State<LidarcomoNovo> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações amostram como as pessoas se sentem sobre si mesmas e outras pessoas. Não há respostas certas ou erradas. O que é importante é o que você pessoalmente acredita ou sente é verdade sobre si mesmo. Leia cada declaração cuidadosamente, então, usando as diretrizes abaixo, marque o quanto você concorda ou discorda dele."+
                                          "\n\nConcordo fortemente"+
                                          "\nConcordo"+
                                          "\nNem concordo nem discorda"+
                                          "\nDiscordar"+
                                          "\nDiscordo fortemente"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P23(widget._codAluno)));
