...
class Confianca extends StatefulWidget {
  String _codAluno;
  Confianca(this._codAluno);
  @override
  _ConfiancaState createState() => _ConfiancaState();
}

class _ConfiancaState extends State<Confianca> {
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P14(widget._codAluno)));
