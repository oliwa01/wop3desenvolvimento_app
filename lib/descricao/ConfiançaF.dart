...
import 'package:wop3desenvolvimento_app/testes/P14F.dart';
...
class ConfiancaF extends StatefulWidget {
  String _codAluno;
  ConfiancaF(this._codAluno);
  @override
  _ConfiancaFState createState() => _ConfiancaFState();
}

class _ConfiancaFState extends State<ConfiancaF> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações dizem respeito a opiniões e sentimentos que você pode segurar em direção a outra pessoa. Com relação a outro específico pessoa em quem você tem uma grande confiança (designado como X), indicar a extensão em que você concorda ou discorda com cada declaração por escrito no número que melhor expressa a sua opinião ou sentimento de acordo com a chave abaixo. Note que há são versões separadas do teste para homens e mulheres." +
                                          "\n\nDISCORDO TOTALMENTE"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => P14F(widget._codAluno)));
