...
class Empatia extends StatefulWidget {
  String _codAluno;
  Empatia(this._codAluno);
  @override
  _EmpatiaState createState() => _EmpatiaState();
}
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações descrevem sentimentos e reações a uma variedade de situações. Usando a escala abaixo, indique o grau para que você concorda com cada declaração."+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P21(widget._codAluno)));
