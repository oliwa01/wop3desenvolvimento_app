...
class AutoEficacia extends StatefulWidget {
  String _codAluno;
  AutoEficacia(this._codAluno);
  @override
  _AutoEficaciaState createState() => _AutoEficaciaState();
}

class _AutoEficaciaState extends State<AutoEficacia> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As seguintes declarações descrevem os sentimentos e reações das pessoas para várias situações. Por favor, leia cada declaração cuidadosamente e descrever até que ponto você concorda com cada declaração, usando uma escala de 14 pontos;"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P18(widget._codAluno)));
