...
class Flexibilidade extends StatefulWidget {
  String _codAluno;
  Flexibilidade(this._codAluno);
  @override
  _FlexibilidadeState createState() => _FlexibilidadeState();
}

class _FlexibilidadeState extends State<Flexibilidade> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Este Teste contem declarações sobre a vida que as pessoas muitas vezes sentem de forma diferente. Esolha a opção para mostrar como você se sente sobre cada um. Leia os itens com atenção, e indique o quanto você pensa cada é uma verdade em geral. Não há respostas certas ou erradas."+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P19(widget._codAluno)));
