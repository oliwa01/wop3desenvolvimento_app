...
class Depressao extends StatefulWidget {
  String _codAluno;
  Depressao(this._codAluno);
  @override
  _DepressaoState createState() => _DepressaoState();
}

class _DepressaoState extends State<Depressao> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Listados abaixo estão uma variedade de pensamentos que aparecem na cabeça das pessoas. Por favor, leia cada pensamento e indique com que frequência, o pensamento lhe ocorreu ao longo da última semana. Leia cada item cuidadosamente e indique a resposta apropriada, usando a escala abaixo."+

                                          "\nO tempo todo"+
                                          "\nMuitas vezes"+
                                          "\nModeradamente com frequência"+
                                          "\nÀs vezes"+
                                          "\nDe jeito nenhum"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P03(widget._codAluno)));
