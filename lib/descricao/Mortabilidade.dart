...
class Mortabilidade extends StatefulWidget {
  String _codAluno;
  Mortabilidade(this._codAluno);
  @override
  _MortabilidadeState createState() => _MortabilidadeState();
}

class _MortabilidadeState extends State<Mortabilidade> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Para cada uma das seguintes declarações, circule o número que a maioria corresponde aos seus sentimentos, maneira de ver as coisas, ou maneira de Vivendo nesta fase de sua vida. "+
                                      "Por favor, note que os números sempre variam de 1 a 7, número 1 indicando forte discordância com a declaração e número 7 indicando forte acordo com a declaração. "+
                                      "Tente usar o número 4 ('neutro') o mínimo possível, uma vez que esta posição indica ausência de julgamento em qualquer direção."+
                                      "\nDICORDO TOTALMENTE"+
                                      "\nDISCORDO MUITO"+
                                      "\nDISCORCO BASTANTE"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P22(widget._codAluno)));
