...
class AutoEstima extends StatefulWidget {
  String _codAluno;
  AutoEstima(this._codAluno);
  @override
  _AutoEstimaState createState() => _AutoEstimaState();
}

class _AutoEstimaState extends State<AutoEstima> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Este questionário foi projetado para medir como você se sente sobre si mesmo. Não é um teste, então não há respostas certas ou erradas. Responda cada item da seguinte forma:"+
                                          "\n\n\nNunca"+
                                          "\nRaramente"+
                                          "\nUm pouco do tempo"+
                                          "\nAlgumas vezes"+
