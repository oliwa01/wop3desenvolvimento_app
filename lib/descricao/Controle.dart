                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "O seguinte questionário deve ser preenchido de acordo como você se sente no presente."+
                                          " Responda com um \n\n'Verdadeito' \n\nou um \n\n'Falso' \n\n dependendo de qual escolha mais precisamente descreve você." +
                                          "\n"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P12(widget._codAluno)));
