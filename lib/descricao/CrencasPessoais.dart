...
class CrencasPessoais extends StatefulWidget {
  String _codAluno;
  CrencasPessoais(this._codAluno);
  @override
  _CrencasPessoaisState createState() => _CrencasPessoaisState();
}

class _CrencasPessoaisState extends State<CrencasPessoais> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "As pessoas têm ideias e crenças diferentes. Estamos interessados em sua opinião sobre algumas declarações. Usando a escala abaixo, selecione a que melhor reflete sua crença sobre cada declaração."+
                                          "\n\n\nConcordo totalmente"+
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P05(widget._codAluno)));
