                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:
                                    Text("O inventário a seguir foi projetado para fornecer informações sobre a maneira como você se expressa. Sua resposta deve indicar como você geralmente expressa se em uma variedade de situações. Se uma situação particular não se aplica a você, responda como você acha que deve agir ou como você gostaria de agir. Sua primeira resposta à pergunta é provavelmente a sua melhor escolha. "+
                                        "\n\nUse:"+
