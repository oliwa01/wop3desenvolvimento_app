...
class Traumas extends StatefulWidget {
  String _codAluno;
  Traumas(this._codAluno);
  @override
  _TraumasState createState() => _TraumasState();
}

class _TraumasState extends State<Traumas> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    width: widthlua-30,
                                    child:                      Text(
                                      "Muitas vezes, pessoas com uma doença crônica ou que tiveram  experiências traumáticas falam não só sobre as coisas negativas, mas também das coisas positivas que aconteceram com eles como resultado de sua doença ou experiência. Abaixo está uma lista de alguns dessas coisas positivos."+
                                          "\n\nISTO NUNCA ACONTECEU COMIGO."+
                                          "\nISTO ACONTECEU MUITO POUCO COMIGO."+
                                          "\nISTO ACONTECEU ALGUMAS VEZES COMIGO."+
                                          "\nISTO ACONTECEU VÁRIAS VEZES COMIGO."+
                                          "\nISTO SEMPRE ACONTECE COMIGO."+
                                          "\n\nPara indicar o grau em que cada um ocorreu em sua vida como resultado de sua doença ou Experiência traumática."
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => P20(widget._codAluno)));
