...
class M_inteligencias extends StatefulWidget {
  String _codAluno;
  M_inteligencias(this._codAluno);
  @override
  _M_inteligenciasState createState() => _M_inteligenciasState();
}

class _M_inteligenciasState extends State<M_inteligencias> {
                                  ...
                                  child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => P27(widget._codAluno)));
